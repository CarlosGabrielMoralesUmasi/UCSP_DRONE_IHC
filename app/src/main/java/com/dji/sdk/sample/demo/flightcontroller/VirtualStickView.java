                    ...
                    if (dataSnapshot.exists()) {
                        ...
                        if (zValue.toString().equals("1")) {
                            ...
                            if (isAscending) {
                                ...
                                float ascentSpeed = 2.0f; // 1 metro por segundo, ajusta según lo necesario
                                flightController.sendVirtualStickFlightControlData(
                                        new FlightControlData(0, 0, 0, ascentSpeed), // Aumenta la velocidad vertical
                            ...
                            isAscending = false;
                            // Detén la velocidad vertical
                            flightController.sendVirtualStickFlightControlData(
                                    new FlightControlData(0, 0, 0, 0), // Detén el ascenso
                                    new CommonCallbacks.CompletionCallback() {
                                        @Override
                                        public void onResult(DJIError djiError) {
                                            if (djiError != null) {
